...
def calculate_eps_k_distance_from_matrix(distance_matrix, k=7):
...
def get_clusters_for_file(distance_matrix):
    ...
    dbscan = DBSCAN(eps=calculate_eps_k_distance_from_matrix(distance_matrix), min_samples=5, metric='precomputed')
